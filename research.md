...
<table>
     <tr>
          <th><a href="http://naimulhassan.github.io/content/papers/alsnet.pdf">ALSNet: A Dilated 1-D CNN for Identifying ALS from Raw EMG Signal</a></th>
          <td><strong>K. M. Naimul Hassan</strong>, Md. Shamiul Alam Hridoy, Naima Tasnim, Atia Faria Chowdhury, Tanvir Alam Roni, Sheikh Tabrez, Arik Subhana, Celia Shahnaz</td>
     ...
     <tr>
          <th><a href="http://naimulhassan.github.io/content/papers/doanet-ssl.pdf">DOANet: a deep dilated convolutional neural network approach for search and rescue with drone-embedded sound source localization</a></th>
          <td>Alif Bin Abdul Qayyum, <strong>K. M. Naimul Hassan</strong>, Adrita Anika, Md. Farhan Shadiq, Md. Mushfiqur Rahman, Md. Tariqul Islam, Sheikh Asif Imran, Shahruk Hossain & Mohammad Ariful Haque _(Published on  in )_</td>
          ...
          <td>EURASIP Journal on Audio, Speech and Music Processing
          </td>
          <td>2020</td>
     </tr>
     <tr>
          <th><a href="http://naimulhassan.github.io/content/papers/profile-modelling-sg.pdf">Electrical Power Consumption Profile Modelling of of Air Conditioner for Smart Grid Load Management</a></th>
          <td><strong>K. M. Naimul Hassan</strong>, Soumav Biswas & Md. Forkan Uddin _(Published in 2020 11th International Conference on Electrical and Computer Engineering (ICECE))_</td>
          ...
          <td>11th International Conference on Electrical and Computer Engineering (ICECE)
          </td>
          <td>2020</td>
     </tr>
